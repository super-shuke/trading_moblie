...
class AppCommon extends ThemeExtension<AppCommon> {
  ...
  factory AppCommon.dark() {
    return const AppCommon(
      ...
      surfaceElevated: Color(0xFF1C2A3A),
      textPrimary: Color(0xFFFFFFFF),
      btnBackgroundPrimary: Color(0xFF91C9F9),
      btnTextPrimary: Color(0xFF08121F),
      textPrimarySameBtn: Color(0xFF91C9F9),
      textSecondary: Color(0xFFAFC7DE),
      textMuted: Color(0xFF7F8EA3),
      border: Color(0xFF314154),
      borderDefault: Color(0xFF91C9F9),
      brand: Color(0xFF91C9F9),
      accentAlt: Color(0xFFD97862),
      amber: Color(0xFFE6B85C),
      priceUp: Color(0xFF80D6A3),
      priceDown: Color(0xFFE0777D),
      radiusSm: 6,
      radiusMd: 10,
      radiusLg: 16,
      space2: 2,
