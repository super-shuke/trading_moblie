...
class RotatingGlobeState extends State<RotatingGlobe>
  ...
  double get _minVerticalRotation => radians(widget.controller.minLatitude);
  double get _maxVerticalRotation => radians(widget.controller.maxLatitude);

  double _clampVerticalRotation(double value) =>
      value.clamp(_minVerticalRotation, _maxVerticalRotation).toDouble();
